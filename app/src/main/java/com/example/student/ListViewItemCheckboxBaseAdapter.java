...
public class ListViewItemCheckboxBaseAdapter extends BaseAdapter {
    ...
    public View getView(int itemIndex, View convertView, ViewGroup viewGroup) {
        ...
        {
            convertView = View.inflate(ctx, R.layout.content_ad_hoc, null);

            CheckBox listItemCheckbox = (CheckBox) convertView.findViewById(R.id.checkbox1);

            TextView listItemText = (TextView) convertView.findViewById(R.id.code);
