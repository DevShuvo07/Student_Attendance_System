...
public class ad_hoc_list extends BaseActivity {
    ...
    TextView sec,course,intake;
    public List<String> list = new ArrayList<String>();
    String std_attn_total,std_id;
    public int M,Total_class_count_all=0;
    public String Attend_day,sum_of_attend,A1,A2, check = String.valueOf(0), Old_attnd;
    public char c,c1;
    String std_attendance;
    int attn_class = 1, check_attn = 0;
    int count , total = 0, total_1 = 0;
        ...
        total = variableClass.getStudent_id_add_hoc_list().size();
        total_1 = variableClass.getStudent_id_add_hoc_list().size();
        count = total;
        setTitle("AD_Hoc ( "+total+" / "+total_1+" )");
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(com.example.student.ad_hoc_list.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        listViewWithCheckbox.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int itemIndex, long l) {
                ...
                // Get the checkbox.
                CheckBox itemCheckbox = (CheckBox) view.findViewById(R.id.checkbox1);
                // Reverse the checkbox and clicked item check state.
                if(itemDto.isChecked())
                {
                    count--;
                    setTitle("AD_Hoc ( "+count+" / "+total_1+" )");
                    Log.e( "onItemClick: ", "1");
        ...
        remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(ad_hoc_list.this).create();
                ...
                alertDialog.setButton(Dialog.BUTTON_POSITIVE, "Confirm", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        //Log.e("response ", String.valueOf(initItemList.get(0)));
                        for(int i=0;i<size;i++)
                        {
                            ...
                            if(dto.isChecked())
                            {
                                ...
                                variableClass.getStudent_id_add_hoc_list().remove(i);

                                //deletestudentID(String.valueOf(initItemList.get(i).getItemText()));
                                i--;
                                size = initItemList.size();
                            }
                            //Log.e("onClick: ", variableClass.getStudent_id_add_hoc_list().get(i));
                        }
                        total = 0;
                        setTitle("AD_Hoc ( "+total+" / "+total+" )");
                        listViewDataAdapter.notifyDataSetChanged();
                    }
                });
...
//                        progressDialog.show();
                        ...
                        for(int i=0;i<size;i++)
                        {
                            ...
                            if(dto.isChecked())
                            {
                                attendance(day_calender,monthofyear,variableClass.getStudent_id_add_hoc_list().get(i));
                                Update_total_class();
                                //add_student(variableClass.getStudent_id_add_hoc_list().get(i));
                                Log.e( "onItemSelected: ", variableClass.getStudent_id_add_hoc_list().get(i));
...
//            }
    ...
    private List<ListViewItemDTO> getInitViewItemDtoList()
    {
        ...
        //Log.e("response ", String.valueOf(variable.getStudentId()));
        //student = getResources().getStringArray(R.array.Student_id);
        student = variable.getStudent_id_add_hoc_list().toArray(new String[variable.getStudent_id_add_hoc_list().size()]);

        final List<ListViewItemDTO> ret = new ArrayList<ListViewItemDTO>();

        int length = student.length;

        for(int i=0;i<length;i++)
        {
            String itemText = student[i];
...
//    private void deletestudentID(String studentID) {
//        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.0.20/android_project/deleteID.php", new Response.Listener<String>() {
//            @Override
//            public void onResponse(String response) {
//                if (response.equalsIgnoreCase("Deleted")){
//                    Toast.makeText(ad_hoc_list.this,"Student ID Deleted Successfully",Toast.LENGTH_SHORT);
//                }
//                else {
//                    Toast.makeText(ad_hoc_list.this,"Something went wrong....",Toast.LENGTH_SHORT);
//                }
//            }
...
//    }
    ...
    private void test123456() {
        VariableClass variable = VariableClass.getInstance();
        String teacher_code = variable.getTd_code();
        ...
        String Dept = student_details.getProgram();
        Log.e("dept  ", Dept);
        String Section = student_details.getSection();

        StringRequest request1 = new StringRequest(Request.Method.POST, "http://192.168.0.20/android_project/total_class.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        A1 = ob.getString("Number_of_class");
                        Log.e( "A1 ",A1);
    ...
    private void add_student(String Student_attend,String Student_id) {
        Student_details student_details = Student_details.getInstance();
        ...
        VariableClass variableClass = VariableClass.getInstance();
        String s_no = variableClass.getS_no();
        String std_at = Student_attend;
        String Std_reg = "U";
        String code = "student_ADD";
//        int std_att_all = Integer.parseInt(attn_class) + S1;
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.0.20/android_project/All.php", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.contains("Yes")){
                    Log.e("onResponse: ", Student_attend);
...
//                    Log.e("onResponse: ", Student_id);
//                    //Log.e("onResponse: ", response);
//                    Toast.makeText(getApplicationContext(),"Student update successfully....."+ response,Toast.LENGTH_SHORT).show();
//                }
//                else if(response.contains("added")){
//                    Log.e("onResponse: ", Student_attend);
//                    Log.e("onResponse: ", Student_id);
//                    //Log.e( "onResponse: ", response);
//                    Toast.makeText(getApplicationContext(),"Student added successfully....." + response,Toast.LENGTH_SHORT).show();
//
//                }
//                else{
//                    Log.e("onResponse: ", Student_attend);
//                    Log.e("onResponse: ", Student_id);
//                    //Log.e( "onResponse: ", response);
//                    Toast.makeText(getApplicationContext(),"something wrong." + response,Toast.LENGTH_SHORT).show();
//                }
            }
        }, new Response.ErrorListener() {
            @Override
        ...
        })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("intake", intake);
                params.put("section", section);
                params.put("attn_day", Student_attend);
                params.put("Std_reg", Std_reg);
                return params;
            }
        };
        RequestQueue requestQueue = Volley.newRequestQueue(this);
                    ...
                    try {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                           ...
                           //A1 = String.valueOf(c);
                            ...
                            //add_student(Student_id, Integer.parseInt(A1));
                        }
                        return;
                    } catch (JSONException e) {
                        e.printStackTrace();
                        //attendance(day_calender,monthofyear,"",Student_id);
                        //add_student(Student_id, Integer.parseInt("0"));
...
//                        Log.e("onResponse: ",sum_of_attend );
    ...
    private void Std_Update(String Student_attend,String Student_id) {
        Student_details student_details = Student_details.getInstance();
        String course = student_details.getProgram();
        String intake = student_details.getIntake();
        String section = student_details.getSection();
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.0.20/android_project/std_attend_update.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                if (response.contains("Yes")){
                    Log.e("onResponse: ", Student_attend);
    ...
    private void total_attendance_update() {
        Student_details student_details = Student_details.getInstance();
        VariableClass variableClass = VariableClass.getInstance();
        String teacher_short_code = variableClass.getTd_code();
        String Dept = student_details.getDEPT();
        String course = student_details.getProgram();
        String intake = student_details.getIntake();
        String section = student_details.getSection();
        String code = "Total_attendance_update";
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.0.20/android_project/All.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.e("onResponse: ", teacher_short_code);
                Log.e("onResponse: ", Dept);
                Log.e("onResponse: ", course);
                Log.e("onResponse: ", intake);
                Log.e("onResponse: ", section);
                Log.e("onResponse: ", String.valueOf(Total_class_count_all));
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
        ...
        })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> params = new HashMap<>();
                params.put("Teacher_Code", teacher_short_code);
                params.put("code", code);
                params.put("Dept", Dept);
                params.put("course_code", course);
                params.put("intake", intake);
                params.put("section", section);
                params.put("number_total_class",String.valueOf(Total_class_count_all));
                return params;
            }
        };
        RequestQueue requestQueue = Volley.newRequestQueue(this);
...
//        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            AlertDialog.Builder builder = new AlertDialog.Builder(ad_hoc_list.this);
            ...
            builder.setMessage("Do you want to SignOut?")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent in = new Intent(ad_hoc_list.this, Login.class);
                            in.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startActivity(in);
                            finish();
//                            Intent intent = new Intent(ad_hoc_list.this, Login.class);
...
//                            finish();
        ...
        if (item.getItemId()==R.id.Teacher_profile)
        {
            ...
            Intent intent = new Intent(ad_hoc_list.this, teacher_Profile.class);
            startActivity(intent);
        }
        ...
        if (item.getItemId()==R.id.About)
        {
            ...
            Intent intent = new Intent(ad_hoc_list.this, About.class);
            startActivity(intent);
        }
